          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                child: Text('刑罰追加', style: TextStyle(color: Colors.white)),
              ),
            ),
            const SizedBox(height: 8),
            Container(
...
//     print('Could not get a legit timezone, setting');
...
//           title: (() {
//             if (_payload == '1') {
//               return Text('勉強したかの確認');
//             } else if (_payload == '2') {
//               return Text('休憩するかの確認');
//             }
//           })(),
...
//                     child: (() {
//                       if (_payload == '1') {
//                         return const Text('勉強していました');
//                       } else if (_payload == '2') {
//                         return const Text('休憩します');
//                       }
//                     })(),
//                   ),
//                   ElevatedButton(
...
//                     child: (() {
//                       if (_payload == '1') {
//                         return const Text('勉強していませんでした');
//                       } else if (_payload == '2') {
//                         return const Text('休憩はしません');
//                       }
//                     })(),
//                   ),
//                 ])))),
